...
#define OVERSAMPLENR 16
    ...
    (THERMISTORHEATER_2 == 1) || (THERMISTORBED == 1)  // 100k bed thermistor
...
#endif
#if (THERMISTORHEATER_0 == 2) || (THERMISTORHEATER_1 == 2) || \
    (THERMISTORHEATER_2 == 2) || (THERMISTORBED == 2)  // 200k bed thermistor
const short temptable_2[][2] PROGMEM = {
    // 200k ATC Semitec 204GT-2
    // Verified by linagee. Source:
    // http://shop.arcol.hu/static/datasheets/thermistors.pdf
    // Calculated using 4.7kohm pullup, voltage divider math, and manufacturer
    // provided temp/resistance
    {1 * OVERSAMPLENR,    848},
...
#endif
#if (THERMISTORHEATER_0 == 3) || (THERMISTORHEATER_1 == 3) || \
    (THERMISTORHEATER_2 == 3) || (THERMISTORBED == 3)  // mendel-parts
...
#if (THERMISTORHEATER_0 == 5) || (THERMISTORHEATER_1 == 5) || \
    (THERMISTORHEATER_2 == 5) ||                              \
    (THERMISTORBED == 5)  // 100k ParCan thermistor (104GT-2)
const short temptable_5[][2] PROGMEM = {
    ...
    (THERMISTORHEATER_2 == 6) ||                              \
    (THERMISTORBED == 6)  // 100k Epcos thermistor
...
#if (THERMISTORHEATER_0 == 7) || (THERMISTORHEATER_1 == 7) || \
    (THERMISTORHEATER_2 == 7) ||                              \
    (THERMISTORBED == 7)  // 100k Honeywell 135-104LAG-J01
...
#if (THERMISTORHEATER_0 == 71) || (THERMISTORHEATER_1 == 71) || \
    (THERMISTORHEATER_2 == 71) ||                               \
    (THERMISTORBED == 71)  // 100k Honeywell 135-104LAF-J01
// R0 = 100000 Ohm
// T0 = 25 °C
// Beta = 3974
// R1 = 0 Ohm
...
#if (THERMISTORHEATER_0 == 8) || (THERMISTORHEATER_1 == 8) || \
    (THERMISTORHEATER_2 == 8) || (THERMISTORBED == 8)
...
#endif
#if (THERMISTORHEATER_0 == 9) || (THERMISTORHEATER_1 == 9) || \
    (THERMISTORHEATER_2 == 9) || (THERMISTORBED == 9)
...
#endif
#if (THERMISTORHEATER_0 == 10) || (THERMISTORHEATER_1 == 10) || \
    (THERMISTORHEATER_2 == 10) || (THERMISTORBED == 10)
...
#if (THERMISTORHEATER_0 == 13) || (THERMISTORHEATER_1 == 13) || \
    (THERMISTORHEATER_2 == 13) || (THERMISTORBED == 13)
...
#if (THERMISTORHEATER_0 == 20) || (THERMISTORHEATER_1 == 20) || \
    (THERMISTORHEATER_2 == 20) ||                               \
    (THERMISTORBED ==                                           \
     20)  // PT100 with INA826 amp on Ultimaker v2.0 electronics
  /* The PT100 in the Ultimaker v2.0 electronics has a high sample value for a
  high temperature. This does not match the normal thermistor behaviour so we
  need to set the following defines */
...
#if (THERMISTORHEATER_0 == 51) || (THERMISTORHEATER_1 == 51) || \
    (THERMISTORHEATER_2 == 51) || (THERMISTORBED == 51)
// 100k EPCOS (WITH 1kohm RESISTOR FOR PULLUP, R9 ON SANGUINOLOLU! NOT
// FOR 4.7kohm PULLUP! THIS IS NOT NORMAL!) Verified by linagee. Calculated
// using 1kohm pullup, voltage divider math, and manufacturer provided
// temp/resistance Advantage: Twice the resolution and better linearity from
// 150C to 200C
...
#if (THERMISTORHEATER_0 == 52) || (THERMISTORHEATER_1 == 52) || \
    (THERMISTORHEATER_2 == 52) || (THERMISTORBED == 52)
// 200k ATC Semitec 204GT-2 (WITH 1kohm RESISTOR FOR PULLUP, R9 ON SANGUINOLOLU!
// NOT FOR 4.7kohm PULLUP! THIS IS NOT NORMAL!) Verified by linagee. Source:
// http://shop.arcol.hu/static/datasheets/thermistors.pdf Calculated using 1kohm
// pullup, voltage divider math, and manufacturer provided temp/resistance
...
#if (THERMISTORHEATER_0 == 55) || (THERMISTORHEATER_1 == 55) || \
    (THERMISTORHEATER_2 == 55) || (THERMISTORBED == 55)
// 100k ATC Semitec 104GT-2 (Used on ParCan) (WITH 1kohm RESISTOR FOR PULLUP, R9
// ON SANGUINOLOLU! NOT FOR 4.7kohm PULLUP! THIS IS NOT NORMAL!) Verified by
// linagee. Source: http://shop.arcol.hu/static/datasheets/thermistors.pdf
// Calculated using 1kohm pullup, voltage divider math, and manufacturer
// provided temp/resistance Advantage: More resolution and better linearity from
// 150C to 200C
...
#if (THERMISTORHEATER_0 == 60) || (THERMISTORHEATER_1 == 60) || \
    (THERMISTORHEATER_2 == 60) ||                               \
    (THERMISTORBED == 60)  // Maker's Tool Works Kapton Bed Thermister
...
#if (THERMISTORHEATER_0 == 110) || (THERMISTORHEATER_1 == 110) || \
    (THERMISTORHEATER_2 == 110) ||                                \
    (THERMISTORBED == 110)  // Pt100 with 1k0 pullup
const short temptable_110[][2] PROGMEM = {
    // only few values are needed as the curve is very flat
    PtLine(0, 100, 1000) PtLine(50, 100, 1000) PtLine(100, 100, 1000)
        PtLine(150, 100, 1000) PtLine(200, 100, 1000) PtLine(250, 100, 1000)
            PtLine(300, 100, 1000)};
#endif
#if (THERMISTORHEATER_0 == 147) || (THERMISTORHEATER_1 == 147) || \
    (THERMISTORHEATER_2 == 147) ||                                \
    (THERMISTORBED == 147)  // Pt100 with 4k7 pullup
const short temptable_147[][2] PROGMEM = {
    // only few values are needed as the curve is very flat
    PtLine(0, 100, 4700) PtLine(50, 100, 4700) PtLine(100, 100, 4700)
        PtLine(150, 100, 4700) PtLine(200, 100, 4700) PtLine(250, 100, 4700)
            PtLine(300, 100, 4700)};
#endif
#if (THERMISTORHEATER_0 == 1010) || (THERMISTORHEATER_1 == 1010) || \
    (THERMISTORHEATER_2 == 1010) ||                                 \
    (THERMISTORBED == 1010)  // Pt1000 with 1k0 pullup
const short temptable_1010[][2] PROGMEM = {
    PtLine(0, 1000, 1000) PtLine(25, 1000, 1000) PtLine(50, 1000, 1000) PtLine(
        75, 1000, 1000) PtLine(100, 1000, 1000) PtLine(125, 1000, 1000)
        PtLine(150, 1000, 1000) PtLine(175, 1000, 1000) PtLine(200, 1000, 1000)
            PtLine(225, 1000, 1000) PtLine(250, 1000, 1000)
                PtLine(275, 1000, 1000) PtLine(300, 1000, 1000)};
#endif
#if (THERMISTORHEATER_0 == 1047) || (THERMISTORHEATER_1 == 1047) || \
    (THERMISTORHEATER_2 == 1047) ||                                 \
    (THERMISTORBED == 1047)  // Pt1000 with 4k7 pullup
const short temptable_1047[][2] PROGMEM = {
    // only few values are needed as the curve is very flat
    PtLine(0, 1000, 4700) PtLine(50, 1000, 4700) PtLine(100, 1000, 4700)
        PtLine(150, 1000, 4700) PtLine(200, 1000, 4700) PtLine(250, 1000, 4700)
...
#define TT_NAME(_N)  _TT_NAME(_N)
  ...
  #define HEATER_0_TEMPTABLE_LEN \
    (sizeof(HEATER_0_TEMPTABLE) / sizeof(*HEATER_0_TEMPTABLE))
#else
...
// value is a high or low temperature
#ifndef HEATER_0_RAW_HI_TEMP
  #ifdef HEATER_0_USES_THERMISTOR  // In case of a thermistor the highest
                                   // temperature results in the lowest ADC
                                   // value
    #define HEATER_0_RAW_HI_TEMP 0
    #define HEATER_0_RAW_LO_TEMP 16383
  #else  // In case of an thermocouple the highest temperature results in the
         // highest ADC value
    #define HEATER_0_RAW_HI_TEMP 16383
    #define HEATER_0_RAW_LO_TEMP 0
  #endif
  ...
  #define HEATER_1_TEMPTABLE_LEN \
    (sizeof(HEATER_1_TEMPTABLE) / sizeof(*HEATER_1_TEMPTABLE))
#else
...
// value is a high or low temperature
  ...
  #ifdef HEATER_1_USES_THERMISTOR  // In case of a thermistor the highest
                                   // temperature results in the lowest ADC
                                   // value
  ...
  #define HEATER_2_TEMPTABLE_LEN \
    (sizeof(HEATER_2_TEMPTABLE) / sizeof(*HEATER_2_TEMPTABLE))
#else
...
// value is a high or low temperature
  ...
  #ifdef HEATER_2_USES_THERMISTOR  // In case of a thermistor the highest
                                   // temperature results in the lowest ADC
                                   // value
...
// value is a high or low temperature
  ...
  #ifdef BED_USES_THERMISTOR  // In case of a thermistor the highest temperature
                              // results in the lowest ADC value
