...
#define BOARD_RAMPS_13_EFF \
  35  // RAMPS 1.3 / 1.4 (Power outputs: Extruder, Fan, Fan)
#define BOARD_RAMPS_13_EEF \
...
#define IS_RAMPS                                            \
  (MB(RAMPS_OLD) || MB(RAMPS_13_EFB) || MB(RAMPS_13_EEB) || \
   MB(RAMPS_13_EFF) || MB(RAMPS_13_EEF))
